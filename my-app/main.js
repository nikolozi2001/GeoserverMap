        ...
        municipalDonwlaod.forEach((item) => {
          item.addEventListener("click", (event) => {
            ...
            if (lang1 === "en") {
              ...
              municipalDonwlaod[59].href = `/municipal/ENG/Construction/Permissions%20granted/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[60].href = `/municipal/ENG/Construction/Completed%20Construction/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[61].href = `/municipal/ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20organizational%20legal%20forms%20in%20Georgia/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[62].href = `/municipal/ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20ownership%20type%20in%20Georgia/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[63].href = `/municipal/ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20type%20in%20Georgia/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[64].href = `/municipal/ENG/Trading/Number%20of%20markets%20and%20fairs%20on%20days%20of%20trade/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[65].href = `/municipal/ENG/Trading/Average%20annual%20number%20of%20employed%20persons/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[66].href = `/municipal/ENG/Trading/Number%20of%20market-place%20and%20sellers%20on%20the%20markets%20and%20fairs/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[67].href = `/municipal/ENG/Trading/Financial%20indices%20of%20markets%20and%20fairs/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[68].href = `/municipal/ENG/Hotels/Number%20of%20hotels%20and%20hotel-type%20establishments%20and%20their%20total%20area/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[69].href = `/municipal/ENG/Hotels/Number%20of%20Rooms%20in%20Hotels%20and%20Hotel-type%20enterprises/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[70].href = `/municipal/ENG/Hotels/Guests/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[71].href = `/municipal/ENG/Hotels/Number%20of%20Employees%20in%20Hotels%20and%20Hotel-type%20enterprises/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[72].href = `/municipal/ENG/TransportAndStorage/Length%20of%20transport%20ways/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[73].href = `/municipal/ENG/Healthcare/Nurses/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[74].href = `/municipal/ENG/Healthcare/Physicians/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[75].href = `/municipal/ENG/Healthcare/Visits/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[76].href = `/municipal/ENG/Healthcare/Medical%20institutions/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[77].href = `/municipal/ENG/Healthcare/Hospitals/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[78].href = `/municipal/ENG/Healthcare/Beds/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[79].href = `/municipal/ENG/Healthcare/Beds%20per%201000/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[80].href = `/municipal/ENG/Healthcare/Staff/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[81].href = `/municipal/ENG/Social%20Statistic/Pensioners/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[82].href = `/municipal/ENG/Social%20Statistic/Recipients%20of%20Social%20Packages/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[83].href = `/municipal/ENG/Social%20Statistic/Socially%20Vulnerable/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[84].href = `/municipal/ENG/Social%20Statistic/Living%20Allowance%20Families/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[85].href = `/municipal/ENG/Education/Preschool%20and%20Education%20Institutions/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[86].href = `/municipal/ENG/Education/General%20Educational%20Institution/${globalResponseNameEN}.xlsx`;
              municipalDonwlaod[87].href = `/municipal/ENG/Culture/${globalResponseNameEN}.xlsx`;
            } else {
              sidetitle.innerHTML = globalResponseName;
              ...
              municipalDonwlaod[59].href = `/municipal/მშენებლობა/მშენებლობაზე%20გაცემული%20ნებართვები/${globalResponseName}.xlsx`;
              municipalDonwlaod[60].href = `/municipal/მშენებლობა/დასრულებული%20მშენებლობა/${globalResponseName}.xlsx`;
              municipalDonwlaod[61].href = `/municipal/ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ორგანიზაციულ-სამართლებლივი%20ფორმების%20მიხედვით/${globalResponseName}.xlsx`;
              municipalDonwlaod[62].href = `/municipal/ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20საკუთრების%20ფორმის%20მიხედვით/${globalResponseName}.xlsx`;
              municipalDonwlaod[63].href = `/municipal/ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ტიპების%20მიხედვით/${globalResponseName}.xlsx`;
              municipalDonwlaod[64].href = `/municipal/ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ვაჭრობის%20დღეთა%20მიხედვით/${globalResponseName}.xlsx`;
              municipalDonwlaod[65].href = `/municipal/ვაჭრობა/ბაზრების%20და%20ბაზრობების%20დირექციებში%20დასაქმებულთა%20რაოდენობა/${globalResponseName}.xlsx`;
              municipalDonwlaod[66].href = `/municipal/ვაჭრობა/ბაზრებში%20და%20ბაზრობებში%20სავაჭრო%20ადგილების%20და%20მოვაჭრეთა%20რაოდენობა/${globalResponseName}.xlsx`;
              municipalDonwlaod[67].href = `/municipal/ვაჭრობა/ბაზრების%20და%20ბაზრობების%20საფინანსო%20მაჩვენებლები/${globalResponseName}.xlsx`;
              municipalDonwlaod[68].href = `/municipal/სასტუმროები/სასტუმროების%20რაოდენობა%20და%20ფართობი/${globalResponseName}.xlsx`;
              municipalDonwlaod[69].href = `/municipal/სასტუმროები/ნომრების%20რაოდენობა%20სასტუმროებსა%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში/${globalResponseName}.xlsx`;
              municipalDonwlaod[70].href = `/municipal/სასტუმროები/სტუმრები/${globalResponseName}.xlsx`;
              municipalDonwlaod[71].href = `/municipal/სასტუმროები/სასტუმროების%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში%20დასაქმებულთა%20რაოდენობა%20სქესის%20მიხედვით/${globalResponseName}.xlsx`;
              municipalDonwlaod[72].href = `/municipal/ტრანსპორტი%20და%20დასაწყობება/საერთო%20სარგებლობის%20საავტომობილო%20გზების%20სიგრძე/${globalResponseName}.xlsx`;
              municipalDonwlaod[73].href = `/municipal/ჯანდაცვა/ექთნების%20რაოდენობა/${globalResponseName}.xlsx`;
              municipalDonwlaod[74].href = `/municipal/ჯანდაცვა/ექიმების%20რაოდენობა/${globalResponseName}.xlsx`;
              municipalDonwlaod[75].href = `/municipal/ჯანდაცვა/მიმართვები/${globalResponseName}.xlsx`;
              municipalDonwlaod[76].href = `/municipal/ჯანდაცვა/პოლიკლინიკები/${globalResponseName}.xlsx`;
              municipalDonwlaod[77].href = `/municipal/ჯანდაცვა/საავადმყოფოების%20რაოდენობა/${globalResponseName}.xlsx`;
              municipalDonwlaod[78].href = `/municipal/ჯანდაცვა/საწოლების%20რაოდენობა/${globalResponseName}.xlsx`;
              municipalDonwlaod[79].href = `/municipal/ჯანდაცვა/საწოლების%20რაოდენობა%201000%20კაცზე/${globalResponseName}.xlsx`;
              municipalDonwlaod[80].href = `/municipal/ჯანდაცვა/ჯანდაცვის%20პერსონალი%201000%20კაცზე/${globalResponseName}.xlsx`;
              municipalDonwlaod[81].href = `/municipal/სოციალური%20სტატისტიკა/პენსიის%20მიმღებები/${globalResponseName}.xlsx`;
              municipalDonwlaod[82].href = `/municipal/სოციალური%20სტატისტიკა/სოციალური%20პაკეტის%20მიმღებთა%20რიცხოვნობა/${globalResponseName}.xlsx`;
              municipalDonwlaod[83].href = `/municipal/სოციალური%20სტატისტიკა/სოციალურად%20დაუცველი%20პირების%20წილი/${globalResponseName}.xlsx`;
              municipalDonwlaod[84].href = `/municipal/სოციალური%20სტატისტიკა/რეგისტრირებული%20და%20საარსებო%20შემწეობის%20მიმღები%20ოჯახების%20რაოდენობა/${globalResponseName}.xlsx`;
              municipalDonwlaod[85].href = `/municipal/განათლება/სკოლამდელი%20აღზრდისა%20და%20განათლების%20დაწესებულებები/${globalResponseName}.xlsx`;
              municipalDonwlaod[86].href = `/municipal/განათლება/ზოგადსაგანმანათლებლო%20დაწესებულებები/${globalResponseName}.xlsx`;
              municipalDonwlaod[87].href = `/municipal/კულტურა/${globalResponseName}.xlsx`;
            }
          });
        });
      });
